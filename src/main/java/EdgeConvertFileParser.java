...
public class EdgeConvertFileParser {
  ...
  protected ArrayList<EdgeTable> alTables, alFields;
  ...
  protected static final String EDGE_ID = "EDGE Diagram File"; // first line of .edg files should be this
  protected static final String SAVE_ID = "EdgeConvert Save File"; // first line of save files should be this
  ...
  public EdgeConvertFileParser(File constructorFile) {
    ...
    alFields = new ArrayList<EdgeTable>();
