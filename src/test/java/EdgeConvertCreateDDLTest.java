...
public class EdgeConvertCreateDDLTest {
  ...
  @Test
  public void testInitializeEmptyTables()
  ...
  public void testGetTable() {
    ...
    assertEquals("Third table doesn't exist, so should equal null", null, test3);
  }
...
// No refactoring needed for this class. It is already well written and easy to
// read.