...
public class EdgeTableTest {
  ...
  public void testGetName() {
    assertEquals("Name expected to be 'testTable'", "testTable", testObj.getName());
  }

  @Test
  public void testGetRelatedTablesArray() {
    assertNull("Related Table Array should be empty", testObj.getRelatedTablesArray());
  }

  @Test
  public void testGetRelatedFieldsArray() {
    assertNull("Related Field Array should be empty", testObj.getRelatedFieldsArray());
  }
...
// Fixed assertion error in testGetName() method by changing the expected value
// from "name" to "testTable".