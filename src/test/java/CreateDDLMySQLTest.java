...
// Used a loop to add native fields to tables in the testSingleTable method.
// Used a loop to call makeArrays() method for each table in the
// testMultipleTablesWithRelationships method.
// Removed unnecessary blank lines for readability.
